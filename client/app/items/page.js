                                    ...
                                    <section key={category} className="space-y-5">
                                        ...
                                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                            {sectionProducts.map((product) => {
                                                ...
                                                const isDescriptionExpanded = expandedDescriptionId === product.id;
                                                const hasLongDescription = (product.description?.trim() || "").length > 90;
                                                    ...
                                                    >
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="p-4 sm:p-5">
                                                                ...
                                                                >
                                                                    {product.description?.trim() || "Freshly prepared on order"}
                                                                </p>
                                                                ...
                                                                {hasLongDescription && (
                                                                    <button
                                                                        ...
                                                                        className="mt-1 inline-flex cursor-pointer items-center gap-1 text-[11px] font-bold text-orange-600 transition-colors hover:text-orange-700"
                                                                    >
                                                                        <span>
